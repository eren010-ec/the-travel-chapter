...
(function (global) {
  ...
  const DICT = {
    en: {
      ...
      'trips.book_now': 'Book Now', 'trips.per_person': '/ person', 'trips.max': 'Max', 'trips.days': 'days',
      ...
      'login.phone_placeholder': '+65 9123 4567', 'login.password_placeholder': '••••••••',
      ...
      'login.verify_default_label': 'We sent a WhatsApp code to your phone.',
      'login.verify_sent': 'We sent a WhatsApp code to {phone}.',
      ...
      'login.forgot_send_button': 'Send WhatsApp Code', 'login.sending_loading': 'Sending…',
      'login.back_to_signin': 'Back to sign in',
      'login.forgot_verify_default_label': 'Enter the code we sent to your WhatsApp.',
      'login.forgot_verify_sent': 'Enter the code we sent to {phone} on WhatsApp.',
      ...
      'login.err_enter_code': 'Enter the code sent to your WhatsApp.',
      ...
      'login.toast_code_resent': 'Code resent via WhatsApp.',
      ...
      'dash.tier_premier_perk1': 'All Explorer benefits', 'dash.tier_premier_perk2': 'Access to Premier trips', 'dash.tier_premier_perk3': 'Priority booking windows', 'dash.tier_premier_perk4': 'Complimentary travel insurance',
      'dash.tier_elite_perk1': 'All Premier benefits', 'dash.tier_elite_perk2': 'Access to Elite-only trips', 'dash.tier_elite_perk3': 'Dedicated travel concierge', 'dash.tier_elite_perk4': 'Airport lounge access',
    ...
    zh: {
      ...
      'trips.book_now': '立即预订', 'trips.per_person': '/ 每人', 'trips.max': '最多', 'trips.days': '天',
      ...
      'login.verify_default_label': '我们已通过WhatsApp向您的手机发送验证码。',
      'login.verify_sent': '我们已通过WhatsApp向 {phone} 发送验证码。',
      ...
      'login.forgot_send_button': '通过WhatsApp发送验证码', 'login.sending_loading': '发送中…',
      'login.back_to_signin': '返回登录',
      'login.forgot_verify_default_label': '请输入我们通过WhatsApp发送的验证码。',
      'login.forgot_verify_sent': '请输入我们通过WhatsApp发送至 {phone} 的验证码。',
      ...
      'login.err_enter_code': '请输入我们通过WhatsApp发送的验证码。',
      ...
      'login.toast_code_resent': '验证码已通过WhatsApp重新发送。',
      ...
      'dash.tier_premier_perk1': '享有探索者全部权益', 'dash.tier_premier_perk2': '畅享尊享行程', 'dash.tier_premier_perk3': '优先预订通道', 'dash.tier_premier_perk4': '免费旅行保险',
      'dash.tier_elite_perk1': '享有尊享全部权益', 'dash.tier_elite_perk2': '畅享至尊专属行程', 'dash.tier_elite_perk3': '专属旅行管家', 'dash.tier_elite_perk4': '机场贵宾室使用权',
    ...
    ms: {
      ...
      'trips.book_now': 'Tempah Sekarang', 'trips.per_person': '/ seorang', 'trips.max': 'Maks', 'trips.days': 'hari',
      ...
      'login.verify_default_label': 'Kami telah menghantar kod WhatsApp ke telefon anda.',
      'login.verify_sent': 'Kami telah menghantar kod WhatsApp ke {phone}.',
      ...
      'login.forgot_send_button': 'Hantar Kod WhatsApp', 'login.sending_loading': 'Menghantar…',
      'login.back_to_signin': 'Kembali ke log masuk',
      'login.forgot_verify_default_label': 'Masukkan kod yang kami hantar ke WhatsApp anda.',
      'login.forgot_verify_sent': 'Masukkan kod yang kami hantar ke {phone} melalui WhatsApp.',
      ...
      'login.err_enter_code': 'Masukkan kod yang dihantar ke WhatsApp anda.',
      ...
      'login.toast_code_resent': 'Kod dihantar semula melalui WhatsApp.',
      ...
      'dash.tier_premier_perk1': 'Semua faedah Explorer', 'dash.tier_premier_perk2': 'Akses ke percutian Premier', 'dash.tier_premier_perk3': 'Tempoh tempahan keutamaan', 'dash.tier_premier_perk4': 'Insurans perjalanan percuma',
      'dash.tier_elite_perk1': 'Semua faedah Premier', 'dash.tier_elite_perk2': 'Akses ke percutian khas Elite', 'dash.tier_elite_perk3': 'Konsierj perjalanan peribadi', 'dash.tier_elite_perk4': 'Akses lounge lapangan terbang',
