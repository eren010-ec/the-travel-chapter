...
(function (global) {
  ...
  const DICT = {
    en: {
      ...
      'gifts.heading': 'Free <em>Gifts</em>',
      ...
      'trips.tba': 'TBA', 'trips.price_tba': 'Price TBA', 'trips.details': 'Details', 'trips.whatsapp': 'WhatsApp',
      'trip_page.back': '← All trips', 'trip_page.overview': 'Overview', 'trip_page.itinerary': 'Itinerary',
      'trip_page.departures': 'Departures', 'trip_page.duration': 'Duration', 'trip_page.price': 'Price',
      'trip_page.whatsapp': 'WhatsApp', 'trip_page.not_found': 'Trip not found. It may have been removed or is no longer available.',
      'trip_page.enquiry_text': "Hi, I'm interested in the {trip} trip. Could you tell me more?",
      ...
      // ── index.html: member rewards ──
      'rewards.eyebrow': 'Member Rewards',
      'rewards.heading': 'Earn as You <em>Travel</em>',
      'rewards.subtext': 'Every booking earns redeemable points. Spend them on gifts and member products in your Rewards Store — no tiers, no expiry.',
      'rewards.card1_title': 'Earn on Every Trip',
      'rewards.card1_perk1': '1 point for every RM you spend',
      'rewards.card1_perk2': 'Points credited when your booking is confirmed',
      'rewards.card2_title': 'Redeem for Rewards',
      'rewards.card2_perk1': 'Browse the Rewards Store in your member portal',
      'rewards.card2_perk2': 'Request gifts and member products with points or cash',
      'rewards.card3_title': 'No Tiers, No Catch',
      'rewards.card3_perk1': 'Every trip is open to every member',
      'rewards.card3_perk2': 'Your points never expire',
      ...
      'contact.form.phone': 'Phone Number', 'contact.form.phone_ph': '+60 12 345 6789',
      ...
      'dash.rewards_heading': 'Rewards <em>Store</em>', 'dash.rewards_subtitle': 'Redeem your points for gifts, or request a member product to buy.',
      'dash.rewards_balance_label': 'redeemable points available',
      'dash.rewards_my_requests': 'My Requests',
      'dash.rewards_redeem': 'Request', 'dash.rewards_pts': 'pts', 'dash.rewards_or': 'or', 'dash.rewards_enquire': 'Enquire',
      'dash.rewards_empty': 'No products available right now — check back soon.',
      'dash.rewards_no_requests': "You haven't requested anything yet.",
      'dash.rewards_modal_title': 'Request Item', 'dash.rewards_method': 'How would you like it',
      'dash.rewards_method_points': 'Redeem with points', 'dash.rewards_method_cash': 'Buy (pay in MYR)',
      'dash.rewards_qty': 'Quantity', 'dash.rewards_note': 'Note (optional)', 'dash.rewards_note_ph': 'Delivery address, size, colour…',
      'dash.rewards_total': 'Total', 'dash.rewards_submit': 'Submit Request',
      ...
      'dash.first_name': 'First Name', 'dash.last_name': 'Last Name', 'dash.email': 'Email', 'dash.phone_number': 'Phone Number',
      'dash.dob': 'Date of Birth', 'dash.nationality': 'Nationality', 'dash.passport': 'Passport Number',
      'dash.first_name_ph': 'Jane', 'dash.last_name_ph': 'Smith', 'dash.email_ph': 'jane@example.com', 'dash.phone_ph': '+60 12 345 6789', 'dash.nationality_ph': 'Malaysian', 'dash.passport_ph': 'A12345678',
      ...
      'dash.checkin_title': 'Daily Check-In', 'dash.checkin_day_streak': 'day streak',
      'dash.checkin_btn': 'Check In', 'dash.checkin_done': 'Checked In ✓',
      'dash.checkin_earn_hint': 'Check in today for +{pts} pts',
      'dash.checkin_come_back': 'Come back tomorrow to keep your streak going',
      'dash.checkin_toast': 'Checked in! +{pts} pts · Day {day} 🔥',
      'dash.checkin_bonus_toast': 'Day {day} bonus! +{pts} pts 🎉',
      'dash.checkin_earn_hint_voucher': 'Check in today for a {reward} voucher',
      'dash.checkin_voucher_toast': 'Voucher unlocked — {reward} off, valid until {date} 🎟️',
      'dash.checkin_earn_hint_draw': 'Check in today to play the Lucky Draw 🎲',
      'dash.draw_title': 'Lucky Draw', 'dash.draw_pick': 'Pick a box — one is yours to keep.',
      'dash.draw_done': 'Nice one!', 'dash.draw_close': 'Collect',
      'dash.draw_box_label': '🎲 Draw', 'dash.draw_open_btn': '🎲 Open Lucky Draw',
      'dash.draw_won': 'You won {prize}!', 'dash.draw_toast': 'Lucky Draw: you won {prize} 🎉',
      'dash.draw_voucher_word': 'voucher',
      'dash.draw_prize_cash': 'Cash {v}', 'dash.draw_prize_trip': 'Trip voucher {v}',
      'dash.draw_prize_hotel': 'Hotel voucher {v}', 'dash.draw_prize_product': 'A product',
    ...
    zh: {
      ...
      'trips.tba': '待定', 'trips.price_tba': '价格待定', 'trips.details': '详情', 'trips.whatsapp': 'WhatsApp',
      'trip_page.back': '← 所有行程', 'trip_page.overview': '行程概览', 'trip_page.itinerary': '行程安排',
      'trip_page.departures': '出发日期', 'trip_page.duration': '行程天数', 'trip_page.price': '价格',
      'trip_page.whatsapp': 'WhatsApp', 'trip_page.not_found': '找不到此行程。它可能已被移除或不再开放。',
      'trip_page.enquiry_text': '您好，我对「{trip}」行程感兴趣，可以告诉我更多详情吗？',
      ...
      'rewards.eyebrow': '会员奖励',
      'rewards.heading': '旅行即<em>赚积分</em>',
      'rewards.subtext': '每次预订都能赚取可兑换积分，在积分商城兑换礼品和会员商品——无等级，不过期。',
      'rewards.card1_title': '每次旅行都赚积分',
      'rewards.card1_perk1': '每消费 1 令吉获 1 积分',
      'rewards.card1_perk2': '预订确认后积分即到账',
      'rewards.card2_title': '兑换心仪好礼',
      'rewards.card2_perk1': '在会员中心浏览积分商城',
      'rewards.card2_perk2': '用积分或现金申请礼品和会员商品',
      'rewards.card3_title': '无等级，无套路',
      'rewards.card3_perk1': '每一条行程都向所有会员开放',
      ...
      'contact.form.phone': '电话号码', 'contact.form.phone_ph': '+60 12 345 6789',
      ...
      'dash.rewards_heading': '积分<em>商城</em>', 'dash.rewards_subtitle': '用积分兑换礼品，或申请购买会员专属商品。',
      'dash.rewards_balance_label': '可用兑换积分',
      'dash.rewards_my_requests': '我的申请',
      'dash.rewards_redeem': '申请', 'dash.rewards_pts': '积分', 'dash.rewards_or': '或', 'dash.rewards_enquire': '咨询',
      'dash.rewards_empty': '目前暂无商品，敬请稍后查看。',
      'dash.rewards_no_requests': '您还没有提交任何申请。',
      'dash.rewards_modal_title': '申请商品', 'dash.rewards_method': '兑换方式',
      'dash.rewards_method_points': '用积分兑换', 'dash.rewards_method_cash': '购买（以令吉支付）',
      'dash.rewards_qty': '数量', 'dash.rewards_note': '备注（选填）', 'dash.rewards_note_ph': '收货地址、尺寸、颜色…',
      'dash.rewards_total': '合计', 'dash.rewards_submit': '提交申请',
      ...
      'dash.first_name': '名字', 'dash.last_name': '姓氏', 'dash.email': '电子邮件', 'dash.phone_number': '电话号码',
      ...
      'dash.checkin_title': '每日签到', 'dash.checkin_day_streak': '天连续签到',
      'dash.checkin_btn': '签到', 'dash.checkin_done': '已签到 ✓',
      'dash.checkin_earn_hint': '今天签到可获 +{pts} 积分',
      'dash.checkin_come_back': '明天再来，保持连续签到',
      'dash.checkin_toast': '签到成功！+{pts} 积分 · 第 {day} 天 🔥',
      'dash.checkin_bonus_toast': '第 {day} 天奖励！+{pts} 积分 🎉',
      'dash.checkin_earn_hint_voucher': '今天签到可获 {reward} 优惠券',
      'dash.checkin_voucher_toast': '已解锁优惠券 — {reward} 折扣，有效期至 {date} 🎟️',
      'dash.checkin_earn_hint_draw': '今天签到即可玩幸运抽奖 🎲',
      'dash.draw_title': '幸运抽奖', 'dash.draw_pick': '选一个盒子 — 抽中即是你的。',
      'dash.draw_done': '恭喜！', 'dash.draw_close': '领取',
      'dash.draw_box_label': '🎲 抽奖', 'dash.draw_open_btn': '🎲 打开幸运抽奖',
      'dash.draw_won': '您抽中了 {prize}！', 'dash.draw_toast': '幸运抽奖：您抽中了 {prize} 🎉',
      'dash.draw_voucher_word': '优惠券',
      'dash.draw_prize_cash': '现金 {v}', 'dash.draw_prize_trip': '行程优惠券 {v}',
      'dash.draw_prize_hotel': '酒店优惠券 {v}', 'dash.draw_prize_product': '实物奖品',
    ...
    ms: {
      ...
      'trips.tba': 'Akan Diumumkan', 'trips.price_tba': 'Harga Akan Diumumkan', 'trips.details': 'Butiran', 'trips.whatsapp': 'WhatsApp',
      'trip_page.back': '← Semua percutian', 'trip_page.overview': 'Gambaran Keseluruhan', 'trip_page.itinerary': 'Jadual Perjalanan',
      'trip_page.departures': 'Tarikh Pelepasan', 'trip_page.duration': 'Tempoh', 'trip_page.price': 'Harga',
      'trip_page.whatsapp': 'WhatsApp', 'trip_page.not_found': 'Percutian tidak dijumpai. Ia mungkin telah dialih keluar atau tidak lagi tersedia.',
      'trip_page.enquiry_text': 'Hai, saya berminat dengan percutian {trip}. Boleh beritahu saya lebih lanjut?',
      ...
      'rewards.eyebrow': 'Ganjaran Ahli',
      'rewards.heading': 'Kumpul Mata Semasa <em>Mengembara</em>',
      'rewards.subtext': 'Setiap tempahan memperoleh mata boleh tebus. Belanjakannya untuk hadiah dan produk ahli di Kedai Ganjaran anda — tiada tahap, tiada tarikh luput.',
      'rewards.card1_title': 'Kumpul Setiap Perjalanan',
      'rewards.card1_perk1': '1 mata bagi setiap RM yang dibelanjakan',
      'rewards.card1_perk2': 'Mata dikreditkan apabila tempahan disahkan',
      'rewards.card2_title': 'Tebus untuk Ganjaran',
      'rewards.card2_perk1': 'Layari Kedai Ganjaran dalam portal ahli anda',
      'rewards.card2_perk2': 'Mohon hadiah dan produk ahli dengan mata atau tunai',
      'rewards.card3_title': 'Tiada Tahap, Tiada Helah',
      'rewards.card3_perk1': 'Setiap percutian terbuka kepada semua ahli',
      ...
      'contact.form.phone': 'Nombor Telefon', 'contact.form.phone_ph': '+60 12 345 6789',
      ...
      'dash.rewards_heading': 'Kedai <em>Ganjaran</em>', 'dash.rewards_subtitle': 'Tebus mata anda untuk hadiah, atau mohon untuk membeli produk ahli.',
      'dash.rewards_balance_label': 'mata boleh tebus tersedia',
      'dash.rewards_my_requests': 'Permohonan Saya',
      'dash.rewards_redeem': 'Mohon', 'dash.rewards_pts': 'mata', 'dash.rewards_or': 'atau', 'dash.rewards_enquire': 'Tanya',
      'dash.rewards_empty': 'Tiada produk buat masa ini — sila semak semula tidak lama lagi.',
      'dash.rewards_no_requests': 'Anda belum memohon apa-apa lagi.',
      'dash.rewards_modal_title': 'Mohon Item', 'dash.rewards_method': 'Bagaimana anda mahukannya',
      'dash.rewards_method_points': 'Tebus dengan mata', 'dash.rewards_method_cash': 'Beli (bayar dalam MYR)',
      'dash.rewards_qty': 'Kuantiti', 'dash.rewards_note': 'Nota (pilihan)', 'dash.rewards_note_ph': 'Alamat penghantaran, saiz, warna…',
      'dash.rewards_total': 'Jumlah', 'dash.rewards_submit': 'Hantar Permohonan',
      ...
      'dash.first_name': 'Nama Pertama', 'dash.last_name': 'Nama Akhir', 'dash.email': 'E-mel', 'dash.phone_number': 'Nombor Telefon',
      ...
      'dash.checkin_title': 'Daftar Masuk Harian', 'dash.checkin_day_streak': 'hari berturut-turut',
      'dash.checkin_btn': 'Daftar Masuk', 'dash.checkin_done': 'Sudah Daftar ✓',
      'dash.checkin_earn_hint': 'Daftar masuk hari ini untuk +{pts} mata',
      'dash.checkin_come_back': 'Kembali esok untuk kekalkan rentetan anda',
      'dash.checkin_toast': 'Berjaya daftar masuk! +{pts} mata · Hari {day} 🔥',
      'dash.checkin_bonus_toast': 'Bonus Hari {day}! +{pts} mata 🎉',
      'dash.checkin_earn_hint_voucher': 'Daftar masuk hari ini untuk baucar {reward}',
      'dash.checkin_voucher_toast': 'Baucar dibuka — potongan {reward}, sah hingga {date} 🎟️',
      'dash.checkin_earn_hint_draw': 'Daftar masuk hari ini untuk main Cabutan Bertuah 🎲',
      'dash.draw_title': 'Cabutan Bertuah', 'dash.draw_pick': 'Pilih satu kotak — satu jadi milik anda.',
      'dash.draw_done': 'Syabas!', 'dash.draw_close': 'Kutip',
      'dash.draw_box_label': '🎲 Cabutan', 'dash.draw_open_btn': '🎲 Buka Cabutan Bertuah',
      'dash.draw_won': 'Anda menang {prize}!', 'dash.draw_toast': 'Cabutan Bertuah: anda menang {prize} 🎉',
      'dash.draw_voucher_word': 'baucar',
      'dash.draw_prize_cash': 'Tunai {v}', 'dash.draw_prize_trip': 'Baucar perjalanan {v}',
      'dash.draw_prize_hotel': 'Baucar hotel {v}', 'dash.draw_prize_product': 'Produk',
